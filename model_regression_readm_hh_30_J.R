...
dataset<-dataset[ , !(names(dataset) %in% c("mort_hh_30", 'readm_30', "entr_g", "mort_30"))]
...
for (i in 1:10){
  ...
  mod_rf <- caret::train(readm_hh_30~., data=data_train, method="LogitBoost", ntree=500, trControl = ctrl,metric="Kappa")
...
mod_readm_hh_LR <- mod_rf
pred_readm_hh_LR <- pred
