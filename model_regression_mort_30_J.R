...
dataset<-dataset[ , !(names(dataset) %in% c("mort_hh_30", 'readm_hh_30', "entr_g", "readm_30"))]
...
for (i in 1:10){
  ...
  mod_rf <- caret::train(mort_30~., data=data_train, method="LogitBoost", ntree=500, trControl = ctrl,metric="Kappa")
