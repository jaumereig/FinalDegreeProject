...
dataset<-dataset[ , !(names(dataset) %in% c("readm_30", 'readm_hh_30', "entr_g", "mort_30"))]
...
for (i in 1:10){
  ...
  mod_rf <- caret::train(mort_hh_30~., data=data_train, method="LogitBoost", ntree=500, trControl = ctrl,metric="Kappa")
